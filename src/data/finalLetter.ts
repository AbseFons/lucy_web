...
export const finalLetter: FinalLetterData = {
  ...
  paragraphs: [
    'Cuando pienso en nosotros, me sigue pareciendo curioso e increíbleque esta historia haya comenzado hace 10 años. En 2016 ya estábamos ahí, sentados juntos casi todo quinto de secundaria, gustándonos sin terminar de saberlo.',
    'Después vinieron 2017, 2018 y hasta 2025. Nos encontramos, nos alejamos y volvimos a encontrarnos. Y ahora me gusta mirar hacia atrás porque todos esos intentos forman parte de cómo llegamos hasta aquí.',
    'El 26 de marzo de 2026 volvimos a hablar una vez más, solo que esta vez fue diferente. Y el 14 de mayo dejamos de ser una posibilidad pendiente para convertirnos finalmente en nosotros, mi amor.',
